    ...
    const responseObject = {
      "pdvService": {
        ...
        "sender": {
            ...
            "countryName": "México",
            "betweenRoadName1": betweenRoadsOrigin[0]? betweenRoadsOrigin[0] : origin?.optionalAddress1? " y ": "",
            ...
            "recipient": {
              ...
              "EquivalentCode": destination.isPudo? destination.pudoInfo?.EquivalentCode : "",
              "TyoeLocationName": destination.isPudo? destination.pudoInfo?.TyoeLocationName : "",
              "SpaceOwnerName": destination.isPudo? destination.pudoInfo?.SpaceOwnerName : "",
              "isSender": "0",
              ...
              "betweenRoadName1": betweenRoadsDestination[0]? betweenRoadsDestination[0] : destination?.optionalAddress1? " y ": "",
